...
3. **PR-only** — branch + PR; do not self-merge.
4. `./scripts/sync-agent-kit.sh` after roadmap `agent-kit/` version bumps.

Skills: `write-li-release-notes`, `li-ecosystem-discipline` (in `.cursor/skills/` after sync).
